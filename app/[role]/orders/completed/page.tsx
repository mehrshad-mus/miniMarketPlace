...
export const Processing = () => {
    ...
    return (
        <div className="bg-gray-100 p-6">
            <div className="font-bold text-[21px] text-end mb-6">تکمیل شده</div>
                    ...
                    <tbody className="rounded-2xl bg-gray-100">
                        <tr className="flex">
                            ...
                            <th className="w-2/20 border border-white text-[13px] items-center justify-center flex p-2">
                                <span className="bg-green-100 text-[10px] text-green-600 p-0.5 px-2 rounded-2xl">در حال پردازش</span>
                            </th>
